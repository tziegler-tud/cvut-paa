...
class KnapSolverPermutations:
    ...
    def run(self):
        ...
        if self.measureRecursionDepth:
            ...
            strD = stdev(recDepthList)
            var = variance(recDepthList)
        ...
        if self.measureError:
            ...
            stdevError = stdev(errorList)
            varError = variance(errorList)


        # to compare different instance encodings, read a file as different encodings of one instance and calculate st. derivation and variance
        # the lower the standard deviation, the higher the robustness of the algorithm.
        ...
        try:
            ...
            infoFile.write("Knapsack Solution Information\n" + "Date: " + str(timestamp) + "\n\n" +
                           ...
                           "\n" + "recursion Depth std derivation: " + str(strD) +
                           "\n" + "variance: " + str(var) + "\n" +
                           "\n" + "error std derivation: " + str(strD) +
                           "\n" + "error variance: " + str(var) + "\n" +
        ...
        return [strD, var, stdevError, varError]
