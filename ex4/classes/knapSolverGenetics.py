...
class KnapSolverGenetics:
    ...
    def run(self):
        ...
        for index, i in enumerate(self.knapInstanceList):
            ...
            # set run id for output files
            self.knapStrategy.setRunId(index)

            # set optimal solution cost
            self.knapStrategy.setOptimalSolution(self.knapInstanceSolutionList.get(i.id))
            ...
            generationCount = info[0]
            populationSize = info[1]
            sol = info[2]
        ...
        try:
            ...
            infoFile.write("Knapsack Solution Information\n" + "Date: " + str(timestamp) + "\n\n" +
                           ...
                           "\n" +
                           "Generations: " + str(generationCount) + "\n"
