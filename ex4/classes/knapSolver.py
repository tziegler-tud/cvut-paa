...
class KnapSolver:
    ...
    def run(self):
        ...
        self.printProgressBar(0, len(self.knapInstanceList), prefix='Progress:', suffix='Complete', length=50)

        for index, i in enumerate(self.knapInstanceList):
            # Update Progress Bar
            self.printProgressBar(abs(index), len(self.knapInstanceList), prefix='Progress:', suffix='Complete', length=50)
